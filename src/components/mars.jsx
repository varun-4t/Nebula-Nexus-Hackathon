...
const MarsWebsite = () => {
  ...
  const infoCards = [
    ...
    },
    {
      ...
      description: 'Mars is the 4th planet from the Sun and often called the "Red Planet" due to its distinct rusty color, caused by iron oxide on its surface. It is the 2nd smallest planet in the Solar System after Mercury, yet it features some of the most spectacular landscapes known, including the tallest volcano, Olympus Mons, and the largest canyon, Valles Marineris.',
      accent: 'blue',
      delay: 400
    },
    {
